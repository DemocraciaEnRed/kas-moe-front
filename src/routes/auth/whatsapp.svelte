<script>
  ...
  function submit() {
    InputValue.length !== 0 ? goto('/auth/whatsapp_success') : null; 
  }
</script>
...
<main>
  <Box>
    ...
    <p>
      No tengo un código de WhatsApp
    </p>
  </Box>
</main>
